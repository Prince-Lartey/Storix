export const siteConfig = {
  ...
  shortName: "STR",
  description:
    "Storix is a powerful and user-friendly inventory management system designed to help businesses track, organize, and optimize their stock in real time. Whether you're managing a warehouse, retail store, or e-commerce backend, Storix offers an intuitive dashboard, low-stock alerts, automated restocking, and insightful analytics—all in one place",

  // Contact Information
  contact: {
    phone: {
      primary: "+233(0) 545743115",
      emergency: "+233(0) 545743115",
      whatsapp: "+233(0) 545743115",
    },
    email: {
      primary: "lartey.princ@gmail.com",
