...
const ReUsableHero: React.FC<HeroProps> = ({
  ...
  return (
    <div className={`relative ${style.background} ${currentTheme.base.text} overflow-hidden ${className}`}>
      {/* Grid background */}
      <div
      ...
      <div className="relative max-w-7xl mx-auto px-4 pt-10 md:pt-12  sm:px-6 lg:px-8 mt-16">
        {announcement && (
